...
|
*/
$config['base_url'] = 'http://localhost/mp/arepa3/';
...
|
*/
$config['encryption_key'] = 'this-is-my-key';
...
$config['csrf_exclude_uris'] = array('admin/blog_admin/get_pictures','admin/notes_admin/get_pictures','admin/algorithms_admin/get_pictures');
