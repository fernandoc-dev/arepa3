        ...
        <section id="content">
            <div class="content-wrap">
                <div class="container clearfix">
                    <h1>Algorithms</h1>
                    <a href="<?php echo base_url("admin/algorithms_admin/create")?>"
                        class="button button-light button-small button-border button-rounded ml-0 mb-4">
                        <i class="icon-line-cog"></i>New algorithm</a>
                                ...
                                foreach ($algorithms as $algorithm) {
                                    echo "
                                        <tr>
                                            ...
                                            <td>
                                                <a target=\"_blank\" href=\"" . base_url("algorithms/") . $algorithm->url .  "\" class=\"button button-3d button-rounded button-green\"><i class=\"icon-book-reader\"></i></a>
                                                <a href=\"" . base_url("admin/algorithms_admin/update/") . $algorithm->id .  "\" class=\"button button-3d button-rounded button-blue\"><i class=\"icon-edit1\"></i></a>
                                                <a href=\"" . base_url("admin/algorithms_admin/delete/") . $algorithm->id .  "\" class=\"button button-3d button-rounded button-red\"><i class=\"icon-trash2\"></i></a>
                                            </td>
                                        </tr>
                                    ";
                                    }
