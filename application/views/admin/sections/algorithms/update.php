                    ...
                    <div class="row gutter-40 col-mb-80">
						...
						============================================= -->
                            <div class="postcontent">
                                <h1>Update an algorithm</h1>

                                <form class="form-row" action="<?php echo base_url("admin/algorithms_admin/update")?>"
                                    method="post" enctype="multipart/form-data">
                                    <input type="hidden" name="<?php echo ($this->security->get_csrf_token_name()); ?>"
                                        value="<?php echo ($this->security->get_csrf_hash()); ?>" />
                                    <input type="hidden" class="form-control" id="id" name="id"
                                        value="<?php if(set_value('id')){echo set_value('id');}else{echo $algorithm->id;} ?>">
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">Title</label>
                                        <input type="text" class="form-control" id="title" name="title"
                                            placeholder="Enter title"
                                            value="<?php if(set_value('title')){echo set_value('title');}else{echo $algorithm->title;} ?>">
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="exampleInputEmail1">URL</label>
                                        <input type="text" class="form-control" id="url" name="url"
                                            placeholder="algorithms/url"
                                            value="<?php if(set_value('url')){echo set_value('url');}else{echo $algorithm->url;} ?>">
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <div style="background-color:#c2c0c0;color:#474747;">
                                            <textarea class="form-control text-black" id="intro" name="introduction"
                                                placeholder="Enter introduction"><?php if(set_value('introduction')){echo set_value('introduction');}else{echo $algorithm->introduction;} ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                        ...
                                        <div style="background-color:#c2c0c0;color:#474747;">
                                            <textarea class="form-control" id="summer-content" name="content"
                                                placeholder="Enter content"><?php if(set_value('content')){echo set_value('content');}else{echo $algorithm->content;} ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6">
...
?>
    ...
    function sendFile(file, el) {
        ...
        $.ajax({
            data: form_data,
            type: "POST",
            url: '<?php echo(base_url('admin/algorithms_admin/get_pictures'))?>',
            cache: false,
            contentType: false,
            processData: false,
