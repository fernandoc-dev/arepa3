...
<head>
    ...
    <!-- Document Title
	============================================= -->
    <title><?php echo $current_algorithm->title?></title>
                            ...
                            <div class="single-post mb-0">
                                ...
                                <div class="entry clearfix">
                                    ...
                                    <div class="entry-title">
                                        <h1><?php echo $current_algorithm->title?></h1>
                                    </div><!-- .entry-title end -->
                                    ...
                                    <div class="entry-meta">
                                        <ul>
                                            <li><i
                                                    class="icon-calendar3"></i><?php echo date("jS M Y", strtotime($current_algorithm->created_at))?>
                                            </li>
                                        </ul>
                                    </div><!-- .entry-meta end -->
                                    ...
                                    <div class="entry-image">
                                        <img src="<?php echo base_url("") . $current_algorithm->main_image ?>"
                                    ...
                                    <div class="entry-content mt-0">
                                        ...
                                        <?php echo $current_algorithm->content?>
                                    ...
                                    <div class=\"entry col-12 col-md-6\">
                                        <div class=\"grid-inner row align-items-center gutter-20\">
                                            ...
                                            <div class=\"col-8\">
                                                ...
                                                <div class=\"entry-meta\">
                                                    <ul>
                                                        <li><i class=\"icon-calendar3\"></i>" . date("jS M Y", strtotime($algorithm->created_at)) . "</li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
