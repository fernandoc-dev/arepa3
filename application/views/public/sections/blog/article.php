			...
			<div id="header-wrap">
				<div class="container">
					<div class="header-row">
						...
						============================================= -->
						<div id="logo">
							<a href="index.html" class="standard-logo" data-dark-logo="<?php echo base_url("assets/canvas/images/logo-dark.png")?>"><img src="<?php echo base_url("assets/canvas/images/logo.png")?>" alt="Canvas Logo"></a>
							<a href="index.html" class="retina-logo" data-dark-logo="<?php echo base_url("assets/canvas/images/logo-dark@2x.png")?>"><img src="<?php echo base_url("assets/canvas/images/logo@2x.png")?>")?>" alt="Canvas Logo"></a>
						</div><!-- #logo end -->
									...
									<div class="top-cart-items">
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="<?php echo base_url("assets/canvas/images/shop/small/1.jpg")?>" alt="Blue Round-Neck Tshirt" /></a>
											</div>
										...
										<div class="top-cart-item">
											<div class="top-cart-item-image">
												<a href="#"><img src="<?php echo base_url("assets/canvas/images/shop/small/6.jpg")?>")?>" alt="Light Blue Denim Dress" /></a>
											</div>
											<div class="top-cart-item-desc">
												<div class="top-cart-item-desc-title">
							...
							<div class="single-post mb-0">
								...
								<div class="entry clearfix">
									...
									<div class="entry-image">
										<a href="#"><img src="<?php echo base_url("assets/canvas/images/blog/full/1.jpg")?>" alt="Blog Single"></a>
									</div><!-- .entry-image end -->
												...
												<div class="posts-sm row col-mb-30" id="popular-post-list-sidebar">
													<div class="entry col-12">
														<div class="grid-inner row no-gutters">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="<?php echo base_url("assets/canvas/images/magazine/small/3.jpg")?>" alt="Image"></a>
																</div>
															</div>
															<div class="col pl-3">
																<div class="entry-title">
													...
													<div class="entry col-12">
														<div class="grid-inner row no-gutters">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="<?php echo base_url("assets/canvas/images/magazine/small/2.jpg")?>" alt="Image"></a>
																</div>
															</div>
															<div class="col pl-3">
																<div class="entry-title">
													...
													<div class="entry col-12">
														<div class="grid-inner row no-gutters">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="<?php echo base_url("assets/canvas/images/magazine/small/1.jpg")?>" alt="Image"></a>
																</div>
															</div>
															<div class="col pl-3">
																<div class="entry-title">
												...
												<div class="posts-sm row col-mb-30" id="recent-comments-list-sidebar">
													<div class="entry col-12">
														<div class="grid-inner row no-gutters">
															<div class="col-auto">
																<div class="entry-image">
																	<a href="#"><img class="rounded-circle" src="<?php echo base_url("assets/canvas/images/icons/avatar.jpg")?>" alt="User Avatar"></a>
																</div>
															</div>
															<div class="col pl-3">
										...
										<div class="oc-item">
											<div class="portfolio-item">
												<div class="portfolio-image">
													<a href="#">
														<img src="<?php echo base_url("assets/canvas/images/portfolio/4/3.jpg")?>" alt="Mac Sunglasses">
													</a>
											...
											<div class="portfolio-item">
												<div class="portfolio-image">
													<a href="portfolio-single.html">
														<img src="<?php echo base_url("assets/canvas/images/portfolio/4/1.jpg")?>" alt="Open Imagination">
													</a>
													<div class="bg-overlay">
														<div class="bg-overlay-content dark" data-hover-animate="fadeIn" data-hover-speed="350">
															<a href="<?php echo base_url("assets/canvas/images/blog/full/1.jpg")?>" class="overlay-trigger-icon bg-light text-dark" data-hover-animate="zoomIn" data-hover-speed="350" data-lightbox="image"><i class="icon-line-plus"></i></a>
														</div>
														<div class="bg-overlay-bg dark" data-hover-animate="fadeIn" data-hover-speed="350"></div>
													</div>
												</div>
