...
<body class="stretched">
	...
	<div id="wrapper" class="clearfix">
		...
		<section id="slider" class="slider-element min-vh-60 min-vh-md-100 include-header">
			...
			<div class="vh-100 vw-100 position-fixed" style="top: 0; left: 0; background: #FFF url('<?php echo base_url("assets/canvas/demos/resume/images/hero-image/1.jpg")?>') no-repeat top center; background-size: cover; background-attachment: fixed;">
			...
			<div class="vh-100 vw-100 position-fixed blurred-img" style="top: 0; left: 0; background: #FFF url('<?php echo base_url("assets/canvas/demos/resume/images/hero-image/1.jpg")?>') no-repeat top center; background-size: cover; background-attachment: fixed;"></div>
		...
		<section id="content" class="bg-transparent">
			<div class="content-wrap pb-0 bg-transparent">
				...
				<div id="section-about" class="section page-section m-0" style="background: #EEE url('<?php echo base_url("assets/canvas/demos/resume/images/sections/1.jpg")?>') no-repeat center center; background-size: cover; padding: 100px 0">
					<div class="container">
						<div class="row">
				...
				<div id="section-works" class="section page-section m-0" style="background: #EEE url('<?php echo base_url("assets/canvas/demos/resume/images/sections/2.jpg")?>') no-repeat center right; background-size: cover; padding: 100px 0">
					<div class="container">
						<div class="row">
								...
								<div class="row clearfix">
									<div class="col-md-6">
										<ul class="niche-demos-lists mb-0 lists-1">
											<li class="mt-0"><a href="demo-restaurant.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/restaurant.jpg")?>" alt="Image">Restaurant Demo</a></li>
											<li><a href="demo-photography.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/photography.jpg")?>" alt="Image">Photography</a></li>
											<li><a href="demo-medical.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/medical.jpg")?>" alt="Image">Medical</a></li>
											<li><a href="demo-spa.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/spa.jpg")?>" alt="Image">Spa</a></li>
											<li><a href="demo-coffee.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/coffee.jpg")?>" alt="Image">Coffee</a></li>
											<li><a href="demo-interior-design.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/interior-design.jpg")?>" alt="Image">Interior Design</a></li>
											<li><a href="demo-barber.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/barber.jpg")?>" alt="Image">Barber</a></li>
										</ul>
									</div>
									<div class="col-md-6">
										<ul class="niche-demos-lists mb-0 lists-2">
											<li><a href="demo-travel.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/travel.jpg")?>" alt="Image">Travel</a></li>
											<li><a href="demo-media-agency.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/media-agency.jpg")?>" alt="Image">Media Agency</a></li>
											<li><a href="demo-construction.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/construction.jpg")?>" alt="Image">Construction</a></li>
											<li><a href="demo-writer.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/writer.jpg")?>" alt="Image">Writer</a></li>
											<li><a href="demo-real-estate.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/real-estate/1.jpg")?>" alt="Image">Real Estate</a></li>
											<li><a href="demo-business.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/business.jpg")?>" alt="Image">Business</a></li>
											<li><a href="demo-app-landing.html"><img src="<?php echo base_url("assets/canvas/images/intro/niche/app-landing.jpg")?>" alt="Image">App Landing</a></li>
										</ul>
									</div>
								</div>
						...
						<div id="posts" class="post-grid row gutter-30 mb-0" data-layout="fitRows">
								...
								<div class="grid-inner">
									<div class="entry-box-shadow">
										<div class="entry-image mb-0">
											<a href="images/blog/full/17.jpg" data-lightbox="image"><img src="<?php echo base_url("assets/canvas/demos/resume/images/blog/1.jpg")?>" alt="Standard Post with Image"></a>
										</div>
							...
							<div class="entry col-md-6 col-lg-4">
								<div class="grid-inner">
									<div class="entry-box-shadow">
										<div class="entry-image mb-0">
											<a href="images/blog/full/17.jpg" data-lightbox="image"><img src="<?php echo base_url("assets/canvas/demos/resume/images/blog/2.jpg")?>" alt="Standard Post with Image"></a>
										</div>
										<div class="entry-meta-wrapper">
											<div class="entry-meta mt-0">
												<a href="#" class="text-muted">March 25th, 2021</a>
							...
							<div class="entry col-md-6 col-lg-4">
								<div class="grid-inner">
									<div class="entry-box-shadow">
										<div class="entry-image mb-0">
											<a href="images/blog/full/17.jpg" data-lightbox="image"><img src="<?php echo base_url("assets/canvas/demos/resume/images/blog/3.jpg")?>" alt="Standard Post with Image"></a>
										</div>
										<div class="entry-meta-wrapper">
											<div class="entry-meta mt-0">
												<a href="#" class="text-muted">March 25th, 2021</a>
